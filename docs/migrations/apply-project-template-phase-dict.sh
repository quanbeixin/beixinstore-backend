...
UP_SQL="$SCRIPT_DIR/2026-03-29-project-template-phase-dict-up.sql"
VERIFY_SQL="$SCRIPT_DIR/2026-03-29-project-template-phase-dict-verify.sql"
...
echo "[DONE] Project template phase dict migration applied and verified successfully."

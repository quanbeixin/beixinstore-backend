...
UP_SQL="$SCRIPT_DIR/2026-07-22-project-template-group-chat-config-up.sql"
VERIFY_SQL="$SCRIPT_DIR/2026-07-22-project-template-group-chat-config-verify.sql"
...
echo "[DONE] Project template group chat config migration applied and verified successfully."

...
UP_SQL="$SCRIPT_DIR/2026-04-13-bug-watchers-up.sql"
VERIFY_SQL="$SCRIPT_DIR/2026-04-13-bug-watchers-verify.sql"
...
echo "[DONE] Bug watchers migration applied and verified successfully."

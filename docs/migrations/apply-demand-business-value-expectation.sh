...
UP_SQL="$SCRIPT_DIR/2026-05-13-demand-business-value-expectation-up.sql"
VERIFY_SQL="$SCRIPT_DIR/2026-05-13-demand-business-value-expectation-verify.sql"
...
echo "[DONE] Demand business value expectation migration applied and verified successfully."

...
UP_SQL="$SCRIPT_DIR/2026-04-14-bug-saved-views-up.sql"
VERIFY_SQL="$SCRIPT_DIR/2026-04-14-bug-saved-views-verify.sql"
...
echo "[DONE] Bug saved views migration applied and verified successfully."

...
UP_SQL="$SCRIPT_DIR/2026-03-30-work-demand-links-up.sql"
VERIFY_SQL="$SCRIPT_DIR/2026-03-30-work-demand-links-verify.sql"
...
echo "[DONE] Work demand links migration applied and verified successfully."

...
UP_SQL="$SCRIPT_DIR/2026-04-15-bug-comment-threading-up.sql"
VERIFY_SQL="$SCRIPT_DIR/2026-04-15-bug-comment-threading-verify.sql"
...
echo "[DONE] Bug comment threading migration applied and verified successfully."

...
UP_SQL="$SCRIPT_DIR/2026-04-15-demand-tech-solutions-up.sql"
VERIFY_SQL="$SCRIPT_DIR/2026-04-15-demand-tech-solutions-verify.sql"
...
echo "[DONE] Demand tech solution fields migration applied and verified successfully."

...
UP_SQL="$SCRIPT_DIR/2026-04-15-bug-comment-attachments-up.sql"
VERIFY_SQL="$SCRIPT_DIR/2026-04-15-bug-comment-attachments-verify.sql"
...
echo "[DONE] Bug comment attachments migration applied and verified successfully."

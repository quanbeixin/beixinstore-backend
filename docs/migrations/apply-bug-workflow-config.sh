...
UP_SQL="$SCRIPT_DIR/2026-04-14-bug-workflow-config-up.sql"
VERIFY_SQL="$SCRIPT_DIR/2026-04-14-bug-workflow-config-verify.sql"
...
echo "[DONE] Bug workflow config migration applied and verified successfully."

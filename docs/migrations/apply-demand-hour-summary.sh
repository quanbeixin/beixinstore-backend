...
UP_SQL="$SCRIPT_DIR/2026-03-30-demand-hour-summary-up.sql"
VERIFY_SQL="$SCRIPT_DIR/2026-03-30-demand-hour-summary-verify.sql"
...
echo "[DONE] Demand hour summary migration applied and verified successfully."

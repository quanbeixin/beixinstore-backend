...
UP_SQL="$SCRIPT_DIR/2026-04-13-demand-release-fields-up.sql"
VERIFY_SQL="$SCRIPT_DIR/2026-04-13-demand-release-fields-verify.sql"
...
echo "[DONE] Demand release fields migration applied and verified successfully."

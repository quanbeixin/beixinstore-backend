...
const NOTE_TYPES = ['DELIVERY', 'OPPO_PUSH', 'REQUIREMENT', 'DESIGN', 'OPERATION', 'FRONTEND', 'BACKEND', 'DEVOPS', 'ADVERTISING', 'DEVELOPMENT']
  ...
  async listByPackageId(packageId) {
    ...
    const [rows] = await pool.query(
      `SELECT
       ...
       ORDER BY FIELD(mpn.note_type, 'DELIVERY', 'OPPO_PUSH', 'REQUIREMENT', 'DESIGN', 'OPERATION', 'FRONTEND', 'BACKEND', 'DEVOPS', 'ADVERTISING', 'DEVELOPMENT'), mpn.id ASC`,
      [matrixPackage.id],
    )

...
const FIELD_DEFINITIONS = {
  ...
  BACKEND: [],
  DEVOPS: [
    { name: 'googleAuthClientId', description: '谷歌鉴权认证ClientId' },
    { name: 'googleAuthClientSecret', description: '谷歌鉴权认证ClientSecret' },
    { name: 'firebaseEmailAccount', description: 'Firebase邮箱账号' },
    { name: 'googlePayPackageName', description: '谷歌支付包名' },
    { name: 'googlePayCertificateUrl', description: '谷歌支付证书地址' },

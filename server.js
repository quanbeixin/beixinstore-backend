...
const developerAccountRoutes = require('./routes/developerAccountRoutes')
const notificationTemplateRoutes = require('./routes/notificationTemplateRoutes')
const matrixPackageDebugRoutes = require('./routes/matrixPackageDebugRoutes')
const matrixPackageNotificationRoutes = require('./routes/matrixPackageNotificationRoutes')
const matrixPackageReviewPlanRoutes = require('./routes/matrixPackageReviewPlanRoutes')
const matrixPackageRoutes = require('./routes/matrixPackageRoutes')
const appVersionReleaseRoutes = require('./routes/appVersionReleaseRoutes')
...
app.use('/api/developer-accounts', developerAccountRoutes)
app.use('/api/work', notificationTemplateRoutes)
app.use('/api/matrix-package-debug', matrixPackageDebugRoutes)
app.use('/api/matrix-package-notifications', matrixPackageNotificationRoutes)
app.use('/api/matrix-package-review-plans', matrixPackageReviewPlanRoutes)
app.use('/api/matrix-packages', matrixPackageRoutes)
app.use('/api/app-version-releases', appVersionReleaseRoutes)
